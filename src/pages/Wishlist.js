    ...
    if (wishlist.length === 0) {
        return (
            <div>
                <Card border="dark">
                    <Card.Body>
                        <Card.Title><h1>Wishlist</h1></Card.Title>
                        <br /><br />
                        <h2>Wishlist is empty . . . </h2>
                    </Card.Body>
                    <Card.Img variant="bottom" style={{width: '300px'}} src="https://i.pinimg.com/originals/5a/76/92/5a7692c44aaa0e61177f9d03195c836a.png"/>
                </Card>
